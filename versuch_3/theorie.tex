\section{Theorie}
\subsection{Newtonsche und Lagrang'sche Mechanik}
...
\begin{equation}
\frac{\partial (E_{kin} - V)}{\partial }\cdot{\varphi_2} = m_2 l_1 l_2 \dot{\varphi_1} \dot{\varphi_2} \sin (\varphi_1 - \varphi_2) - m_2 g l_2 \sin \varphi_2
\end{equation}
\begin{equation}
