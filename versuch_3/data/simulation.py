...
def simu(t0, x1, y1, x2, y2, phi_1, phi_2, intervall, laenge_sim, anz_schritte_pro_ausgabe): 
	...
	phi1 = atan(-x1/y1) # Winkel des ersten Pendels zur Senkrechten, Konvention: Winkel im 4. Quadraten sind positiv
	phi2 = atan((x1-x2)/(y2-y1))
	t = t0 # Startzeitpunkt
	g = 9.81 # Ortsfaktor
	M = m1+m2 # Gesamtmasse
	phi__1 = 0 # zur anfänglichen Berechnung werden die Winkelbeschleunigungen auf Null gesetzt
	phi__2 = 0
