...
\begin{figure}
        \includegraphics[width=.9\textwidth]{dNdt(t)MWmitaltenWerten.png}
\caption{Einteilung in Fraktionen}
...
\begin{figure}
        \includegraphics[width=.9\textwidth]{Fit dNdt(t).png}
...
\begin{figure}
        \includegraphics[width=.9\textwidth]{Fit T(t).png}
\caption{Fit von T(t)}
\label{dNdt(t)MWmitaltenWerten}
\end{figure}
...
\begin{figure}
        \includegraphics[width=.9\textwidth]{alpha(T)mitFit.png}
